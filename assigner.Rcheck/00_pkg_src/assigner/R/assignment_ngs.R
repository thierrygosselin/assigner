...
#' \item \strong{Filtered data:} This function does not silently perform
#' general genomic quality control. Read and standardize data with
...
#' The alternative \href{https://github.com/eriqande/gsi_sim}{gsi_sim} engine is
#' an external command-line program and is not installed by \pkg{assigner}.
