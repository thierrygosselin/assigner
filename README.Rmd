...
* bug fix `assignment_ngs` during imputation, the imputation module could not recognise that REF/ALT allele
are not necessary or usefull for assignment analysis.
...
Iterations at this point is useless.
