...
Remaining work is validation against published examples, simulations,
and established programs including `ade4`, `pegas`, `poppr`, Arlequin,
GenoDive, and Stacks; deeper testing of informative missingness; and
