...
[`pegas::amova()`](https://rdrr.io/pkg/pegas/man/amova.html) uses a
convenient formula interface such as `distance ~ region/population`. It
accepts a distance matrix, calculates hierarchical variance components,
and implements level-specific permutations ([Paradis
2010](#ref-Paradis2010)). Its source uses the exact Excoffier
coefficients for one- and two-level hierarchies and documented
approximate formulae for deeper hierarchies.
...
[`poppr::poppr.amova()`](https://grunwaldlab.github.io/poppr/reference/poppr.amova.html)
provides an important bridge from `adegenet` genetic objects to either
the `ade4` or `pegas` AMOVA engines. It supports clonal data, haplotype
splitting, mixed reproductive systems, missing-data preprocessing, and
corrections for non-Euclidean distances ([Kamvar et al.
2014](#ref-Kamvar2014), [2015](#ref-Kamvar2015)).
...
#> 4  loc_12  0.5063272  0.03518519 0.2981481 22      4      TRUE  -1.632993e-15
#> 5   loc_2  0.2358076 -0.06604938 0.6814815 22      4      TRUE  -1.980694e-15
#> 6   loc_3  0.1589945 -0.06736720 0.3598039 21      4      TRUE  -1.660146e-15
#>   CORRECTION
#> 1          0
#> 2          0
#> 3          0
