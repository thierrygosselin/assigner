...
```{r fig1, echo = FALSE}
embed_png("assignment_thl_test1.png")
```
...
```{r fig2, echo = FALSE}
embed_png("assignment_thl_test1_full_range.png")
```
...
```{r fig3, echo = FALSE}
embed_png("assignment_thl_test2.png")
```
...
```{r fig4, echo = FALSE}
embed_png("membership_dataset1.png")
```
...
```{r fig5, echo = FALSE}
embed_png("assignment_thl_test3.png")
```
...
```{r fig6, echo = FALSE}
embed_png("membership_dataset2.png")
```
...
```{r fig7, echo = FALSE}
embed_png("assignment_loo_test4.png")
```
